...
//                        ReservationDetail reservationDetail = new ReservationDetaileservationDetail(n, entry.getKey(), cart.getService().getService_price(), cart.getQuantity(), cart.getNum_of_person(), cart.getService().getCategory_id(), cart.getDoctor_id(), cart.getNurse_id(), cart.getBegin_time(), cart.getSlot(), cart.getChildren_id().get(i));
